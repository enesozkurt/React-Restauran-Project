...
class ContactComponent extends Component{
    ...
    validate(firstname,lastname,telnum,email) {
        ...
        if (this.state.touched.email && email.split('').filter(x => x === '@').length !== 1)
            errors.email = "Email should conain a @";
                ...
                <div className="row row-content">
                    ...
                    <div className="col-12 col-sm-4 offset-sm-1">
                        ...
                        <address>
                            ...
                            ENGLAND<br />
                            <i className="fa fa-phone"></i>:  +90 555 555 5555<br />
                            <i className="fa fa-fax"></i>:  +90 555 555 5555 <br />
                            <i className="fa fa-envelope"></i>: <a href="mailto:example@example.com">example@example.com</a>
                        </address>
                    </div>
